...
//+kubebuilder:rbac:groups=apiextensions.k8s.io,resources=customresourcedefinitions;customresourcedefinitions/status,verbs=create;get;list;patch;update;watch
//+kubebuilder:rbac:groups=apiextensions.k8s.io,resources=customresourcedefinitions;customresourcedefinitions/status,verbs=create;get;list;patch;update;watch
...
//+kubebuilder:rbac:groups=appconfiguration.azure.com,resources=configurationstores/finalizers;configurationstores/status;keyvalues/finalizers;keyvalues/status;replicas/finalizers;replicas/status;snapshots/finalizers;snapshots/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=appconfiguration.azure.com,resources=configurationstores/finalizers;configurationstores/status;keyvalues/finalizers;keyvalues/status;replicas/finalizers;replicas/status;snapshots/finalizers;snapshots/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=appconfiguration.azure.com,resources=configurationstores;keyvalues;replicas;snapshots,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=appconfiguration.azure.com,resources=configurationstores;keyvalues;replicas;snapshots,verbs=create;delete;get;list;patch;update;watch
...
//+kubebuilder:rbac:groups=cognitiveservices.azure.com,resources=accounts/finalizers;accounts/status;deployments/finalizers;deployments/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=cognitiveservices.azure.com,resources=accounts/finalizers;accounts/status;deployments/finalizers;deployments/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=cognitiveservices.azure.com,resources=accounts;deployments,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=cognitiveservices.azure.com,resources=accounts;deployments,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=compute.azure.com,resources=availabilitysets/finalizers;availabilitysets/status;capacityreservationgroups/finalizers;capacityreservationgroups/status;capacityreservations/finalizers;capacityreservations/status;diskaccesses/finalizers;diskaccesses/status;diskencryptionsets/finalizers;diskencryptionsets/status;disks/finalizers;disks/status;images/finalizers;images/status;snapshots/finalizers;snapshots/status;virtualmachines/finalizers;virtualmachines/status;virtualmachinescalesets/finalizers;virtualmachinescalesets/status;virtualmachinescalesetsextensions/finalizers;virtualmachinescalesetsextensions/status;virtualmachinesextensions/finalizers;virtualmachinesextensions/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=compute.azure.com,resources=availabilitysets/finalizers;availabilitysets/status;capacityreservationgroups/finalizers;capacityreservationgroups/status;capacityreservations/finalizers;capacityreservations/status;diskaccesses/finalizers;diskaccesses/status;diskencryptionsets/finalizers;diskencryptionsets/status;disks/finalizers;disks/status;images/finalizers;images/status;snapshots/finalizers;snapshots/status;virtualmachines/finalizers;virtualmachines/status;virtualmachinescalesets/finalizers;virtualmachinescalesets/status;virtualmachinescalesetsextensions/finalizers;virtualmachinescalesetsextensions/status;virtualmachinesextensions/finalizers;virtualmachinesextensions/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=compute.azure.com,resources=availabilitysets;capacityreservationgroups;capacityreservations;diskaccesses;diskencryptionsets;disks;images;snapshots;virtualmachines;virtualmachinescalesets;virtualmachinescalesetsextensions;virtualmachinesextensions,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=compute.azure.com,resources=availabilitysets;capacityreservationgroups;capacityreservations;diskaccesses;diskencryptionsets;disks;images;snapshots;virtualmachines;virtualmachinescalesets;virtualmachinescalesetsextensions;virtualmachinesextensions,verbs=create;delete;get;list;patch;update;watch
...
//+kubebuilder:rbac:groups=containerregistry.azure.com,resources=registries;registryreplications,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=containerservice.azure.com,resources=fleets/finalizers;fleets/status;fleetsautoupgradeprofiles/finalizers;fleetsautoupgradeprofiles/status;fleetsmembers/finalizers;fleetsmembers/status;fleetsupdateruns/finalizers;fleetsupdateruns/status;fleetsupdatestrategies/finalizers;fleetsupdatestrategies/status;maintenanceconfigurations/finalizers;maintenanceconfigurations/status;managedclusters/finalizers;managedclusters/status;managedclustersagentpools/finalizers;managedclustersagentpools/status;trustedaccessrolebindings/finalizers;trustedaccessrolebindings/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=containerservice.azure.com,resources=fleets/finalizers;fleets/status;fleetsautoupgradeprofiles/finalizers;fleetsautoupgradeprofiles/status;fleetsmembers/finalizers;fleetsmembers/status;fleetsupdateruns/finalizers;fleetsupdateruns/status;fleetsupdatestrategies/finalizers;fleetsupdatestrategies/status;maintenanceconfigurations/finalizers;maintenanceconfigurations/status;managedclusters/finalizers;managedclusters/status;managedclustersagentpools/finalizers;managedclustersagentpools/status;trustedaccessrolebindings/finalizers;trustedaccessrolebindings/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=containerservice.azure.com,resources=fleets;fleetsautoupgradeprofiles;fleetsmembers;fleetsupdateruns;fleetsupdatestrategies;maintenanceconfigurations;managedclusters;managedclustersagentpools;trustedaccessrolebindings,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=containerservice.azure.com,resources=fleets;fleetsautoupgradeprofiles;fleetsmembers;fleetsupdateruns;fleetsupdatestrategies;maintenanceconfigurations;managedclusters;managedclustersagentpools;trustedaccessrolebindings,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=containerservice.azure.com,resources=fleetsmembers/status;maintenanceconfigurations/status;managedclusters/status;managedclustersagentpools/status,verbs=get;list;watch
//+kubebuilder:rbac:groups=containerservice.azure.com,resources=fleetsmembers/status;maintenanceconfigurations/status;managedclusters/status;managedclustersagentpools/status,verbs=get;list;watch
//+kubebuilder:rbac:groups=containerservice.azure.com,resources=fleetsmembers;maintenanceconfigurations;managedclusters;managedclustersagentpools,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=containerservice.azure.com,resources=fleetsmembers;maintenanceconfigurations;managedclusters;managedclustersagentpools,verbs=create;delete;get;list;patch;update;watch
...
//+kubebuilder:rbac:groups=kubernetesconfiguration.azure.com,resources=extensions;fluxconfigurations,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=kusto.azure.com,resources=clusters/finalizers;clusters/status;databases/finalizers;databases/status;dataconnections/finalizers;dataconnections/status;principalassignments/finalizers;principalassignments/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=kusto.azure.com,resources=clusters/finalizers;clusters/status;databases/finalizers;databases/status;dataconnections/finalizers;dataconnections/status;principalassignments/finalizers;principalassignments/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=kusto.azure.com,resources=clusters;databases;dataconnections;principalassignments,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=kusto.azure.com,resources=clusters;databases;dataconnections;principalassignments,verbs=create;delete;get;list;patch;update;watch
...
//+kubebuilder:rbac:groups=proxy.open-cluster-management.io,resources=clusterstatuses/aggregator,verbs=get;create
//+kubebuilder:rbac:groups=proxy.open-cluster-management.io,resources=managedproxyconfigurations;managedproxyconfigurations/status;managedproxyconfigurations/finalizers,verbs=*
//+kubebuilder:rbac:groups=quota.azure.com,resources=quotas,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=quota.azure.com,resources=quotas,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=quota.azure.com,resources=quotas/finalizers;quotas/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=quota.azure.com,resources=quotas/finalizers;quotas/status,verbs=get;patch;update
